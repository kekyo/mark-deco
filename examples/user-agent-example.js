import { createMarkdownProcessor, createOEmbedPlugin, defaultProviderList } from '../dist/index.js';
...
async function demonstrateUserAgentSettings() {
  try {
    ...
    console.log('   User-Agent: AcmeCorp-ContentProcessor/1.5.0 (+https://acme.com/bot-info)');
    ...
    console.log('- Default configuration result:', result1.html.length, 'characters');
    console.log('- Custom configuration result:', result2.html.length, 'characters');
    console.log('- Enterprise configuration result:', result3.html.length, 'characters');
    
    // Notes for when actual HTTP requests occur
    console.log('\n=== Important Notes ===');
    console.log('In actual external API requests, user agent is used in the following scenarios:');
    console.log('1. Fetching oEmbed provider information (oembed.com/providers.json)');
