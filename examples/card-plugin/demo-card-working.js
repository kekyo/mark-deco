...
`;
  ...
  try {
    ...
    const checks = {
      ...
      'GitHub content': result.html.includes('github.com') || result.html.includes('Visual Studio Code'),
      'Example.com content': result.html.includes('example.com') || result.html.includes('Example Domain'),
    ...
    // Extract first card
    const firstCardMatch = result.html.match(/<div class="card-container">.*?<\/style>/s);
    if (firstCardMatch) {
